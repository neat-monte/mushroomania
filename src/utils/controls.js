...
export const categoricalProperties = [
  ...
  {displayName: "Damage Visibility", propName: "doesBruiseOrBleed", values: 
    {true: "Bruising or Bleeding", false: "No changes"}},
  {displayName: "Ring or not", propName: "hasRing", values: 
